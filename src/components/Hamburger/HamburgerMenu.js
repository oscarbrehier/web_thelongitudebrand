export function HamburgerMenu({ active }) {
    ...
    return (
        ...
        <div className={`w-full h-auto bg-neutral-300 border-x-[1px] border-b-[1px] rounded-b border-neutral-200 flex flex-col ${active ? 'block' : 'hidden'}`}>
            ...
            <a href="/shop" className="p-2 border-b-[1px] border-neutral-400 border-opacity-50">
                <p className="text-sm uppercase font-helvetica" href="">shop</p>
            </a>
            <a className="p-2 border-b-[1px] border-neutral-400 border-opacity-50">
                <p className="text-sm uppercase font-helvetica" href="">women</p>
            </a>
            <a className="p-2 border-neutral-400 border-opacity-50">
                <p className="text-sm uppercase font-helvetica" href="">men</p>
            </a>
