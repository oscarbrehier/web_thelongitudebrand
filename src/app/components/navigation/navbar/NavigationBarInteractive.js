...
export default function NavigationBarInteractive({ lang, isAuth: initialAuth }) {
    ...
    const authState = isAuth !== null ? isAuth : initialAuth;
    ...
    return (
        ...
        <nav ref={menuRef} className={`${menu ? "h-auto" : "h-auto"} w-full flex flex-col`}>
            ...
            <div className={`
                h-10 w-full md:grid lg:grid-cols-4 md:grid-cols-3 gap-2
                flex flex-col items-center justify-center bg-neon-green text-xs z-20 top-4`}>

                <div
                    className="md:w-1/4 w-full md:block flex md:pb-0 md:items-start md:justify-center
                    ...
                    <div className={`md:hidden flex items-center space-x-2`}>
                        ...
                        <Link href="/cart" className="size-7 relative">
                            ...
                            <div className="absolute size-4 bg-black rounded-full right-0 flex items-center justify-center">
                                <p className={`text-white ${cartLength >= 10 ? "text-xs" : "text-md"}`}>{cartLength}</p>
                            </div>
                ...
                <div className="w-full md:flex hidden items-center justify-end h-10 col-span-1">

                    {/* <div className="md:hidden w-auto flex justify-start space-x-2 bg-blue-400">
            ...
            <MobileMenu active={menu} lang={lang} auth={authState} openModal={handleOpenModal} />
