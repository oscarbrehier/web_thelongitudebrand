...
import getOrder from "@/lib/firestore/getOrder";
import { useEffect, useState } from "react";
import { IoAirplane, IoCalendarSharp } from "react-icons/io5";
    ...
    useEffect(() => {
        ...
        const getOrderData = async () => {
            ...
            if (res) {
                ...
                res.order["date"] = formatTimestamp(res.order.at);
            ...
            <div className="w-full h-auto grid md:grid-cols-2 md:space-y-0 space-y-4">
                ...
                <div className="w-full h-auto xs:space-y-0 space-y-2">
                    ...
                    <div>
                        ...
                        <p className="md:text-xl text-2xl">#{data.order.orderId}</p>
                    </div>
                ...
                <div className="w-full h-56 bg-cream-200 p-4 flex flex-col justify-between">
                    ...
                    <div className="w-full flex justify-between children:text-sm">
                        ...
                        <div className="text-end">
                            <p>{data.checkout.amount_subtotal / 100}€</p>
                            <p>{data.checkout.total_details.amount_shipping}€</p>
                            <p>{data.checkout.total_details.amount_tax}€</p>
                            <p>- {data.checkout.total_details.amount_discount}€</p>
                        </div>
                    ...
                    <div className="w-full flex justify-between children:font-medium children:capitalize">
                        <p>total</p>
                        <p>{data.checkout.amount_total / 100}€</p>
                    </div>
